...
import icon1 from "../public/assets/img/icon/star-2.svg";
import icon4 from "@/public/assets/img/icon/search.svg";
import icon5 from "@/public/assets/img/icon/us_flag.png";
import icon6 from "@/public/assets/img/icon/arrow_down.svg";
import logo from "@/public/assets/img/logo/logo.svg";
import menus from "@/app/api/menus";
// import MobileMenu from "../MobileMesnu/MobileMenu";
      ...
      <div className={`offcanvas-sidebar ${sitebarActive ? "active" : ""}`}>
        ...
        <div className="sidebar-top mb-130">
          ...
          <div className="sidebar-content">
            Book your Dream Vacation Today and Let the Journey of a Lifetime
            Begin & Create Memory
          </div>
        </div>
